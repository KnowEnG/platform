...
export function getInteractionNetworkOptions(species: Species[], networks: AnalysisNetwork[]): SelectFormField[] {
    return species.map(s => {
        return new SelectFormField("network_name", null, "1", "Select Interaction Network for analysis", "Interaction Network", true,
