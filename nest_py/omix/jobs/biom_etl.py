...
def upload_tornado_run(client_registry, biom_table):
    """
    hardcoded to create a tornado_run entry of the Mayo data
    from March16, 2016
    """
    tornado_schema = tornado_runs.generate_schema()
    tle = tablelike_entry.TablelikeEntry(tornado_schema)
    tle.set_value('date_of_run', '2016-03-16T00:00:00Z')
    tle.set_value('display_name_short', 'Mayo_16Mar2016')
